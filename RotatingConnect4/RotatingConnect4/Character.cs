...
namespace RotatingConnect4
{
    class Character
    {
        ...
        public void rotate(float amountToRotate)
        {
            //Vector2 location = new Vector2(characterRec.Center.X, characterRec.Center.Y);
            rotationAngle += amountToRotate;

            //sb.Draw(character, location, sourceRectangle, Color.White, amountToRotate, origin, 1.0f, SpriteEffects.None, 1);
        }
        ...
        {
            return isRedTile || isBlueTile;
        }

        public void setIsRedTile()
        {
            isRedTile = true;
            isBlueTile = false;
        }

        public void setIsBlueTile()
        {
            isRedTile = false;
            isBlueTile = true;
        }
        ...
        public bool getIsRedTile()
        {
            return isRedTile;
        }

        public bool getIsBlueTile()
        {
            return isBlueTile;
        }
        ...
        public void DrawCharacterWithRotation(SpriteBatch sb)
        {
            center = new Vector2(characterRec.Center.X + 50, characterRec.Center.Y);

            sb.Draw(character, center, new Rectangle(0, 0, character.Width, character.Height), Color.White, this.rotationAngle, new Vector2(100,0), 1.0f, SpriteEffects.None, 1);
